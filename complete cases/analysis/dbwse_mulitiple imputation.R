...
nhanes_20112018 <- readRDS(paste0(path_nhanes_dmbf_folder, "/working/cleaned/dbwse01_unweighted sample.RDS"))
...
continuous_vars <- c("urine_albumin", "urine_creatinine", "alt", "ast", "bun",
                     ...
                     "diastolic4", "poverty", "a1c", "fasting_length_hr", 
                      "hdl", "insulin_level", "glucose2h", "visceral_fat", "subcutaneous_fat",
                     "ogtt_time", "total_cholesterol", "ldl", "triglyceride","eGFR")
...
id_vars <- c("respondentid", "psu", "pseudostratum", "intweight", "mec2yweight", "dm_age", "year",
             ...
             "dm_doc_told", "glycohemoglobin", "fasting_glucose","fat_percentage",
             # no missing values
...
saveRDS(mi_dfs, paste0(path_nhanes_dmbf_folder, "/working/cleaned/mi_dfs_cca.RDS"))
