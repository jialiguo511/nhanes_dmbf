...
nhanes_20112018 <- bind_rows(
  ...
  mutate(normalizedmec2yweight = case_when(year == "2011-2012" ~ mec2yweight*(2/8),
                                           year == "2013-2014" ~ mec2yweight*(2/8),
                                           year == "2015-2016" ~ mec2yweight*(2/8),
                                           year == "2017-2018" ~ mec2yweight*(2/8)))
