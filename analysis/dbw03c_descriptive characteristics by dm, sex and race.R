  ...
  nhanes_total_svy <- df %>% 
    ...
    mutate(
      dm_race_sex = case_when(
        female == 1 & race_eth == "NH White" & dm == "normal" ~ "female NHWhite normal",
        female == 0 & race_eth == "NH White" & dm == "normal" ~ "male NHWhite normal",
        female == 1 & race_eth == "NH Black" & dm == "normal" ~ "female NHBlack normal",
        female == 0 & race_eth == "NH Black" & dm == "normal" ~ "male NHBlack normal",
        female == 1 & race_eth == "Hispanic" & dm == "normal" ~ "female Hispanic normal",
        female == 0 & race_eth == "Hispanic" & dm == "normal" ~ "male Hispanic normal",
        female == 1 & race_eth == "Asian" & dm == "normal" ~ "female Asian normal",
        female == 0 & race_eth == "Asian" & dm == "normal" ~ "male Asian normal",
        female == 1 & race_eth == "NH White" & dm == "prediabetes" ~ "female NHWhite prediabetes",
        female == 0 & race_eth == "NH White" & dm == "prediabetes" ~ "male NHWhite prediabetes",
        female == 1 & race_eth == "NH Black" & dm == "prediabetes" ~ "female NHBlack prediabetes",
        female == 0 & race_eth == "NH Black" & dm == "prediabetes" ~ "male NHBlack prediabetes",
        female == 1 & race_eth == "Hispanic" & dm == "prediabetes" ~ "female Hispanic prediabetes",
        female == 0 & race_eth == "Hispanic" & dm == "prediabetes" ~ "male Hispanic prediabetes",
        female == 1 & race_eth == "Asian" & dm == "prediabetes" ~ "female Asian prediabetes",
        female == 0 & race_eth == "Asian" & dm == "prediabetes" ~ "male Asian prediabetes",
...
all_results <- bind_rows(
  ...
  rename(estimate = theta_D,
         CI_lower = L, 
         CI_upper = U) %>% 
  write_csv(., "analysis/dbw03c_descriptive characteristics by dm, sex and race.csv")
