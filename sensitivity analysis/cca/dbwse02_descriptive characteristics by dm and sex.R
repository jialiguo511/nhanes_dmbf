...
nhanes_svy_dfs <- readRDS(paste0(path_nhanes_dmbf_folder, "/working/cleaned/dbwse01_weighted df with complete cases.RDS")) 
...
all_results <- bind_rows(
  ...
  write_csv(., "sensitivity analysis/dbwse02_descriptive characteristics by dm and sex.csv")
