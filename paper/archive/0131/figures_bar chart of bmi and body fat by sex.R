...
plot_data <- fig_df %>%
  ...
  mutate(female_prop = round((female_n/total_n)*100, 1),
         male_prop = round((male_n/total_n)*100, 1))
...
ggsave(combined_plot, filename=paste0(path_nhanes_dmbf_folder, "/figures/barchart of body fat in bmi by sex.png"),width=7.5, height = 10)
