...
fig_df <- read_csv("new and established dm/analysis/dbw03c_descriptive characteristics by dm, sex and race.csv") %>% 
...
ggsave(bmi_plot,filename=paste0(path_nhanes_dmbf_folder,"/figures/new and established dm/forest plot of mean and ci of bmi by dm, race and sex.jpg"),width=12,height =8)
...
ggsave(fat_plot,filename=paste0(path_nhanes_dmbf_folder,"/figures/new and established dm/forest plot of mean and ci of body fat by dm, race and sex.jpg"),width=12,height =8)
