...
fig_df <- read_csv("new and established dm/analysis/dbw03d_descriptive characteristics by dm and year.csv") %>% 
...
ggarrange(fig_bmi,
          ...
          nrow = 1,
          ncol = 2) %>% 
  ggsave(.,filename=paste0(path_nhanes_dmbf_folder,"/figures/new and established dm/trend of BMI and BF by year.jpg"),width=12,height = 8)

#-------------------------------------------------------------------------

fig_df <- read_csv("new and established dm/analysis/dbw03e_descriptive characteristics by dm, sex and year.csv") %>% 
...
ggarrange(fig_bmi_male,
          ...
          nrow = 2,
          ncol = 2) %>% 
  ggsave(.,filename=paste0(path_nhanes_dmbf_folder,"/figures/new and established dm/trend of BMI and BF by year and sex.jpg"),width=12,height = 8)
...
ggarrange(fig_bmi_male,
          ...
          nrow = 2,
          ncol = 2) %>% 
  ggsave(.,filename=paste0(path_nhanes_dmbf_folder,"/figures/new and established dm/trend of BMI and BF by year and sex no DM.jpg"),width=12,height = 8)
...
ggarrange(fig_bmi_male,
          ...
          nrow = 2,
          ncol = 2) %>% 
  ggsave(.,filename=paste0(path_nhanes_dmbf_folder,"/figures/new and established dm/trend of BMI and BF by year and sex NoDM and PreDM.jpg"),width=12,height = 8)
